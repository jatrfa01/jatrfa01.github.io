...
//url: 'http://en.wikipedia.org/w/api.php?action=parse&page=' + inputText + '=text&format=json&callback=?'
//url: 'http://en.wikipedia.org/w/api.php?format=json&action=query&titles=Main%20Page&prop=revisions&rvprop=content&callback=?',
// JavaScript Document
  $.getJSON('http://en.wikipedia.org/w/api.php?action=parse&page=' + inputText + '=text&format=json&callback=?', function(json) { 
